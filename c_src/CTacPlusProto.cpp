...
CTacPlusProto::CTacPlusProto() : CBaseProto()
{

}

CTacPlusProto::~CTacPlusProto(void)
{
...
std::string CTacPlusProto::authenticate_system(const char *username, const char *password, const char *service)
{
    ...
    /*retval = PAM_author_acct(pamh, (char*)cmd);
    if (retval != PAM_SUCCESS)
    {
    	//printf("pam author_acct\n");
...
std::string CTacPlusProto::execCmd(std::string cmd)
{
...
int CTacPlusProto::PAM_author_acct(pam_handle_t *pamh, char *cmd) {
